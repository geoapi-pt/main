...
const districtsDataDomEl = document.getElementById('districts-route-data')
const districtsData = JSON.parse(decodeURIComponent(districtsDataDomEl.dataset.districtsroute))
window.districtsData = districtsData
console.log('districtsData:', districtsData)

// hide some div
document.querySelector('.container-table100.map-related-info').style.display = 'none'
...
const keysMapingObj = {}
for (const el of districtsData.keysMaping) {
